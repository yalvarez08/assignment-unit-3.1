...
let favoriteFoods = ['sushi', 'curry', 'tacos', 'dumplings'];
...
console.log('Added a dessert to end of favorite foods,', favoriteFoods);
...
console.log('Removed last color. List of colors is now:', colors);
